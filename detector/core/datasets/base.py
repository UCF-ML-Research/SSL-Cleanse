...
class BaseDataset(metaclass=ABCMeta):
    ...
    def __init__(
        self, bs_train, aug_cfg, num_workers, bs_clf=100, bs_test=100,
    ):
    ...
    @abstractmethod
    def ds_train_eval(self):
        raise NotImplementedError

    @lru_cache()
    def train(self, read_label):
        return DataLoader(
            dataset=self.ds_train(read_label),
